      ...
      >
        ...
        >
          ...
          {isAuthed ? (
            <Link href="/profile">
              <Button
                size="sm"
                className="ml-4 bg-pink-500 hover:bg-pink-600 text-white rounded-full font-[Comic Sans MS,Comic Sans,cursive] border-2 border-pink-300"
                onClick={playClick}
              >
                Profile
              </Button>
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 z-10 relative">
          <section className="w-full max-w-2xl flex flex-col items-center justify-center gap-1">
            ...
            >
              <h1
                className="text-5xl font-bold text-white drop-shadow-lg mb-4 text-center"
                style={{ textShadow: "0 0 16px #fff, 0 0 32px #1a237e" }}
              >
                Welcome to Space Math!
              </h1>
              <p
                className="text-lg text-white/90 mb-8 max-w-xl text-center"
                style={{ textShadow: "0 0 8px #000" }}
              >
                Embark on a cosmic journey to master math skills. Choose your
                path and start learning with fun, interactive games!
              </p>
              <div className="flex gap-6 flex-wrap justify-center">
                ...
                <Link href="/math">
                  <button
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, #a259ff 0%, #f500c7 100%)",
                      color: "#fff",
